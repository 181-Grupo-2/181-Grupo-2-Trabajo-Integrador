...
formularioUsuarios.addEventListener('submit', (event) => {
  ...
  costoEnvio = peso * 1000; // Cálculo del costo de envío

  document.getElementById('usuariosRespuesta');
  usuariosRespuesta.textContent = `Hola ${nombre} ${apellido}, el costo de envío de un paquete ${tamaño} que pesa ${peso} Kilogramos y se enviará a ${provincia} es de $${costoEnvio}.`;
